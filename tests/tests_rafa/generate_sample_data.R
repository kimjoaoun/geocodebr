...
dani_like <- function(){
  df_duck_dani_like <- geocodebr:::geocode_like(
    addresses_table = df,
    address_fields = fields,
    n_cores = ncores,
    progress = T
...
#     dani 17.34309 20.84231 21.37072 21.52810 23.11929 23.58630    10
# danilike 23.07892 23.54843 25.47306 25.38518 26.86731 29.55030    10
#     rafa 12.90632 15.21324 15.96307 15.88546 16.96037 19.24135    10
